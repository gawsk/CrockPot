...
########################
    ...
    # Test the Login page with a Email and Password and can reach page behind
    # login wall
    def test_02_01_login_test(self):
        ...
        response = self.app.post(
            '/login', data={'email': testuser_email, 'password': testuser_password, 'submit': 'Login'}, follow_redirects=False)
    ...
    def test_02_02_login_failed_test(self):
        ...
        response1 = self.app.post(
            '/login', data={'email': testuser_email, 'password': 'BAD_PASSWORD', 'submit': 'Login'}, follow_redirects=False)
